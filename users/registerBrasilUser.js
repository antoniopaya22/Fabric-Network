...
var configFilePath = path.join(__dirname, './ConnectionProfileBrasil.yml');
...
var store_path = path.join(os.homedir(), './hfc-key-store/brasil');
...
fabric_client.initCredentialStores().then(() => {
    ...
    if (user_from_store && user_from_store.isEnrolled()) {
        ...
        throw new Error('Failed to get admin.... run registerBrasilAdmin.js');
    }
